...
const Color appColor = Color(0xFF0F4059);

const Color kWhite = Colors.white;
const Color kBlack = Colors.black;
const Color kGrey = Colors.grey;
const Color kRed = Color(0xFFF14336);
...
//App Bar
const Color appBarBackgroundColor = Color(0xFFF9F9F9);
const Color appBarTitleColor = Color(0xFF2D060A);
